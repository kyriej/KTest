...
public class MainActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_kdrag_horizontal).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent();
                intent.putExtra("flag","v");
                intent.setClass(MainActivity.this,KDragLayoutActivity.class);
                startActivity(intent);
            }
        });

        findViewById(R.id.button_kdrag_vertical).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent();
